...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <form action="" method="POST">
            ...
            <img src="./css/bkash.png" alt="" style="display:flex;justify-content:center;align-item:center;padding:20px;margin-left:45px;">
                ...
                <div class="payment-input-group">
                    <div class="payment-input-box">
                        <input type="tel" placeholder="Enter Your Bkash Number" required class="name" name="card_num">
                ...
                <div class="payment-input-group">
                    <div class="payment-input-box">
                        <input type="password" placeholder="Enter Pin Code " required class="name" style="height: 100%;"
                            name="card_cvc">
                        <i class="fa-solid fa-user icon"></i>
                    </div>
                    <div class="payment-input-box">
                ...
                <div class="payment-input-group">
                    <div class="payment-input-box">
                        <button type="submit" name="submit" style="background:#FF007F;">Pay Now</button>
                    </div>
                </div> 

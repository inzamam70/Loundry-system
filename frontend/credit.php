...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <form action="" method="POST">
            ...
            <img src="./css/mastercard.png" alt="" style="display:flex;justify-content:center;align-item:center;padding:20px;margin-left:100px;height:200px;">

                <h4>Account</h4>
                <div class="payment-input-group">
                    <div class="payment-input-box">
                        <input type="text" placeholder="Name on Card" required class="name" name="full_name">
                ...
                <div class="payment-input-group">
                    <div class="payment-input-box">
                        <button type="submit" name="submit" style="background:#FFFF00;">Pay Now</button>
                    </div>
                </div> 

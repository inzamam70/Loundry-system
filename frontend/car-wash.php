            ...
            <div class="laundry-container">
                <div class="laundry-header">
                    <div class="laundry-header-item">
                        <h1 class="laundry-header-h1">Car Wash Price List</h1>
                        ...
                        <table class="laundry-table-table">
                            ...
                            <tbody class="laundry-table-body">
                                <tr class="laundry-table-body-tr">
                                    <td>1</td>
                                    <td>Basic Car Wash Package</td>
                                    <td>৳ 250.00</td>
                                </tr>
                                <tr class="laundry-table-body-tr">
                                    <td>2</td>
                                    <td>Mid-Priced Car Wash Package</td>
                                    <td>৳ 230.00</td>
                                </tr>
                                <tr class="laundry-table-body-tr">
                                    <td>3</td>
                                    <td>Complete Car Wash Package </td>
                                    <td>৳ 50.00</td>
                                </tr>
                                <tr class="laundry-table-body-tr">
                                    <td>4</td>
                                ...
                                <tr class="laundry-table-body-tr">
                                    <td>5</td>
                                    <td>Exterior Restoration</td>
                                    <td>৳ 50.00</td>
                                </tr>
                                <tr class="laundry-table-body-tr">
                                    <td>6</td>
                                    <td>Interior Restoration</td>
                                    <td>৳ 60.00</td>
                                </tr>
                                <tr class="laundry-table-body-tr">
                                    <td>7</td>

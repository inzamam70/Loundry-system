...
<body>
    ...
    <div class="template">
        ...
        <div class="body">
            ...
            <div class="from-body">
                <div class="title">
                    <h1 class="title-item">Roles</h1>
                </div>

                <div class="form">
                    <div class="from-btn">
                    <a href="./add-role.php" class="btn btn-success"><i class="fa-solid fa-plus"></i></a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-btn">
                                                <a href="./edit-role.php?id=<?php echo $row['id'] ?>" class="btn btn-primary"><i class="fa-solid fa-pen-nib"></i></a>
                                                <a href="./delete-role.php?id=<?php echo $row['id'] ?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
